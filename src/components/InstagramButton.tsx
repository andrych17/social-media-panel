  ...
  return (
    <div className="fixed bottom-24 right-6 z-50">
      ...
      <a
        ...
        className="relative flex items-center justify-center w-14 h-14 rounded-full shadow-[0_4px_20px_rgba(225,48,108,0.4)] hover:shadow-[0_4px_30px_rgba(225,48,108,0.6)] hover:scale-110 transition-all duration-300"
        style={{
          background:
